...
/*   Updated: 2022/09/27 11:14:47 by aleferra         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap() : _name("Clap") , _HitPoint(10) , _EnergyPoint(10), _AttackDamage(0)
{
...
ClapTrap::~ClapTrap()
{
	std::cout << RED << "Delete Clap" << WHT << std::endl; 
}
